...
// createUserWithEmailAndPassword() → both creates and authenticates the user.
// If email already exists → Firebase automatically stops and throws an error.
// After success → Auth.currentUser now holds the new signed-in user.
    try {
      ...
      if(error.code === "auth/email-already-in-use"){
        Alert.alert(
  "Signup Error",
  "This email already exists! go to Sign in",
  [{ text: "OK" }]
           );
        } 
        ...
        <View className=" flex justify-center items-center">
          ...
          <View className="w-5/6">
            ...
            <View className="items-center mt-8">
              <TouchableOpacity className="flex flex-row items-center" onPress={() => router.push("/signin")}>
              <Text className="text-white font-semibold ">already a user?  </Text>
              <Text className="text-[#f49b33] font-semibold underline text-base">sign in</Text>
            </TouchableOpacity>
            </View>
